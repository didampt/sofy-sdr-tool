...
//   GET ?register=1  -> enregistre le webhook chez Lemlist (POST /api/hooks, tous événements) avec un secret
//   GET ?hooks=1     -> liste les webhooks enregistrés chez Lemlist (vérification)
...
export default async function handler(req, res) {
  ...
  // 1) Enregistrement one-shot du webhook chez Lemlist (tous les événements)
  ...
  // 1bis) Lister les webhooks enregistrés (vérification)
