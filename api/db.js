...
export async function ajouterHotLead(profil, cfg) {
  ...
  ents.unshift({
    ...
    a_enrichir: true,
    signal_hot: true,
    signal: { type: profil.type, source: profil.source, detail: profil.detail, date: maintenant, pages: profil.pages_visitees || [], signup: profil.signup || null, post: profil.post || null, accroche: profil.accroche || null },
    contacts: profil.nom_complet ? [{
      ...
      signal: { type: profil.type, source: profil.source, detail: profil.detail, date: maintenant, post: profil.post || null, accroche: profil.accroche || null }
    }] : []
  });
